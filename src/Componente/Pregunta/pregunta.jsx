        ...
        return ( 
            <Row className='m-0 p-0 RowPre w-100'>
                <Col className='m-0 p-0 ColPre'>
                    ...
                    interest me. I’ve always thought that the most extraordi-
                    nary results can be found in between things, and this is
                    ...
                    that is why my process-driven practice celebrates experimenta-
                    tion by testing the limits of both analogue and digital tools, so as
                    ...
                    cultures and anything with which I cross paths. In my experi-
                    ence, exploring a wide spectrum of disciplines has allowed me
                    to understand that failure is part of the game. Without risks, you
                    get safe design. Without being open to experience or vulnerabili-
                    ty to what is in front of you, there can be no change. I’m now
                    ...
                    constantly to the same graphical decisions. Besides, document-
                    ing every step of the design process - from initial sketches to
                ...
                connected to other ideas and it may be generated by the meet-
                ing of a word with an object, a movie, a moment in life or even an
                ...
                scientific minds has enabled me to always be curious, investi-
                gate and to fully immerse myself in the projects I participate in. </label>
                </label>
                ...
                <label className=' labelPre'>I truly believe that one of the most important things to keep in
                    ...
                    with an original language, developed in a collaborative environ-
                    ment where the creative process is as enjoyable as the result.</label>
                </label>
                ...
                walking the streets. That being said, I’m not averse to comput-
                ers, but I do like to be aware of when I’m using them.</label>
                </label>
                ...
                <label className=' labelPre'>Working with people from diverse backgrounds as varied as
                    ...
                    method encourages independent thinking alongside a collabora-
                    tive effort among creatives. Not to mention that it produces new
